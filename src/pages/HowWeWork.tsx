...
const steps = [
  ...
  },
  {
    ...
    title: "Подбор",
    description:
      "Наши специалисты ищут подходящие варианты на аукционах Японии, Южной Кореи и Китая. Отправляем вам фото, историю и отчёт о состоянии автомобиля.",
    icon: "Search",
  },
  {
    number: "03",
    title: "Аукцион",
    description:
      "После вашего согласия участвуем в торгах и выкупаем автомобиль по лучшей цене. Вы видите реальную стоимость покупки без скрытых наценок.",
    icon: "Gavel",
  },
  {
    number: "04",
