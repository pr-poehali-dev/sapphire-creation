...
const steps = [
  ...
  },
  {
    ...
    description:
      "Организуем морскую перевозку автомобиля из Южной Кореи во Владивосток. Берём на себя все таможенные процедуры, уплату пошлин и оформление документов. Держим вас в курсе на каждом этапе.",
    icon: "Ship",
  },
  {
    number: "07",
