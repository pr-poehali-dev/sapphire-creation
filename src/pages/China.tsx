...
const steps = [
  {
    ...
    description:
      "Вы описываете желаемый автомобиль — марку, модель, комплектацию, год выпуска (для б/у) и бюджет. Мы подбираем варианты у дилеров новых автомобилей или изучаем актуальные варианты подержанных автомобилей через наше представительство в Китае.",
    icon: "ClipboardList",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    title: "Подбор",
    description:
      "Наши специалисты в Китае подбирают конкретные варианты автомобилей у дилеров и проверенных продавцов, соответствующие вашим требованиям, и присылают вам фото и характеристики каждого варианта.",
    icon: "ListChecks",
  },
  {
    number: "04",
    ...
    description:
      "Бронируем понравившийся вариант и направляем к нему эксперта для проверки технического состояния, кузова и юридической чистоты автомобиля.",
    icon: "ShieldCheck",
  },
  {
    number: "05",
    ...
    description:
      "Оплата автомобиля производится через банк ВТБ по инвойсу — быстро, безопасно и прозрачно.",
    icon: "Landmark",
  },
  {
    number: "06",
