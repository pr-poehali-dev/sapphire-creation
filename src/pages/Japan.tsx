...
const steps = [
  ...
  },
  {
    ...
    description:
      "После выкупа проводим дополнительный осмотр автомобиля на месте. Проверяем кузов, двигатель, ходовую часть и комплектацию. Отправляем вам подробный фотоотчёт.",
    icon: "Search",
  },
  {
    number: "05",
