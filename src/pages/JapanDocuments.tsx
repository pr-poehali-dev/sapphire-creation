...
const documents = [
  {
    ...
    description: "Скан-копия паспорта для заключения договора и оформления таможенных документов.",
    icon: "BookUser",
  },
  {
  ...
  },
  {
    ...
    description: "Копия водительского удостоверения покупателя.",
    icon: "IdCard",
  },
  {
    title: "Регистрация на сайте ЭПТС",
    description: "Необходима для оформления электронного паспорта транспортного средства.",
    icon: "Globe",
  },
];
...
export default function JapanDocuments() {
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="px-6 sm:px-12 pt-10 pb-6 border-b border-neutral-800">
        ...
        <p className="uppercase text-neutral-400 text-xs sm:text-sm tracking-[0.3em] mb-3">ПРО 100 АВТО — Япония</p>
      ...
      <div className="max-w-3xl mx-auto px-6 sm:px-12 py-16">
        ...
        >
          Для покупки автомобиля из Японии от вас потребуется стандартный пакет документов физического лица.
        </motion.p>
